...
public class Helper_product extends AppCompatActivity {
    ...
    static void touch_the_product(final DatabaseReference mDatabase, final FirebaseUser user, final String myposition, final String shopname_load, FragmentManager manager, String tipe_shop, Touch_product product_touch_listenr) {
